...
Core   (src/core/) — decision/, health/, policy/, portfolio/, ports/, research/, risk/, screening/, action_item_bridge, action_item_detector, common, critic_calibration, exposure, health_check, health_etf, health_labels, lesson_gate, market_dashboard, models, proactive_engine, provenance, return_estimate, technicals, temporal, ticker_utils, value_trap
Data   (src/data/) — brokers/, context/, graph_query/, graph_store/, grok_client/, history/, yahoo_client/, critic_feed, embedding_client, finnhub_client, lesson_community, lesson_conflict, linear_client, moomoo_client, note_manager, question_log, rakuten_csv, rakuten_rss, rakuten_trades, user_profile
