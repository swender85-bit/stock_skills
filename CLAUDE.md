...
Output (src/output/) — adjust_formatter, analyze_formatter, constraint_formatter, fable5_formatter, forecast_formatter, formatter, health_formatter, portfolio_formatter, rebalance_formatter, reconcile_formatter, research_formatter, review_formatter, screening_summary_formatter, simulate_formatter, stress_formatter, sync, verify, weekly_diff_formatter, weekly_formatter
