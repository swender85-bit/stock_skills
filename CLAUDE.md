...
Core   (src/core/) — decision/, health/, policy/, portfolio/, ports/, research/, risk/, screening/, action_item_bridge, action_item_detector, common, exposure, health_check, health_etf, health_labels, lesson_gate, market_dashboard, models, proactive_engine, provenance, return_estimate, technicals, temporal, ticker_utils, value_trap
