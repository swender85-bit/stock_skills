...
Core   (src/core/) — decision/, health/, policy/, portfolio/, ports/, reading/, research/, risk/, screening/, action_item_bridge, action_item_detector, common, critic_calibration, env, exposure, health_check, health_etf, health_labels, lesson_gate, market_dashboard, models, observation, power, primary_source, proactive_engine, provenance, return_estimate, technicals, temporal, ticker_utils, value_trap
Data   (src/data/) — brokers/, context/, graph_query/, graph_store/, grok_client/, history/, yahoo_client/, critic_feed, edgar_client, edinet_client, embedding_client, finnhub_client, lesson_community, lesson_conflict, linear_client, moomoo_client, note_manager, question_log, rakuten_csv, rakuten_rss, rakuten_trades, resolver, user_profile
Output (src/output/) — adjust_formatter, analyze_formatter, constraint_formatter, fable5_formatter, forecast_formatter, formatter, forward_formatter, health_formatter, liquidity_formatter, marginal_formatter, portfolio_formatter, rebalance_formatter, reconcile_formatter, research_formatter, review_formatter, screening_summary_formatter, simulate_formatter, stress_formatter, sync, verify, weekly_diff_formatter, weekly_formatter
